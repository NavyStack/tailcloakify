...
ADD --chown=keycloak:keycloak https://github.com/NavyStack/tailcloakify/releases/download/v2.0.2/keycloak-theme-for-kc-all-other-versions.jar /opt/keycloak/providers/keycloak-theme-for-kc-all-other-versions.jar
